...
const EnhancedMLFQHandler: NextApiHandler = async (req, res) => {
  ...
  // Run the scheduler
  const scheduler = new EnhancedMLFQ(processes, startTime);
  ...
  return res.status(200).json({
    ...
    avgTurnaroundTime,
    avgResponseTime,
  } satisfies EnhancedMLFQResponse);
};

export default EnhancedMLFQHandler;
